...
export const RightSidebar: React.FC<RightSidebarProps> = ({ user, banks, transactions, className }) => {
  return (
    <aside className={cn("right-sidebar", className)}>
      ...
      <section className="banks">
        ...
        {banks?.length > 0 && (
          <div className="relative flex flex-1 flex-col items-center justify-center gam-5">
